...
& "$Env:JAVA_HOME\bin\jpackage" `
	...
	--java-options "-Dcryptomator.integrationsWin.windowsHelloKeychainPaths=`"@{appdata}/$AppName/windowsHelloKeychain.json;@{userhome}/AppData/Roaming/$AppName/windowsHelloKeychain.json`"" `
